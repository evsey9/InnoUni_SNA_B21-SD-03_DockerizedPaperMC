...
exec gosu $DOCKER_USER:$DOCKER_GROUP java -Dlog4j.configurationFile=/opt/minecraft/log4j2.xml -Dlog4j2.formatMsgNoLookups=true -Dlog4j2.debug=true -jar -Xms$MEMORYSIZE -Xmx$MEMORYSIZE $JAVAFLAGS /opt/minecraft/paperspigot.jar $PAPERMC_FLAGS nogui
